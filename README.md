...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 41704857-3f25-4143-83df-0541750988ba
```

> `41704857-3f25-4143-83df-0541750988ba` is the password of the certificate, you can change it to any password you want.
